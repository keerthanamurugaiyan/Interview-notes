...
**17. Math Properties:**
        ...
        console.log(Math.min(4,6));    //output:4
        console.log(Math.max(6,3));    //output:6
        console.log(Math.random());    //output:0.5487990729071615
        console.log(Math.floor(Math.random()*100+1));    //output:55
